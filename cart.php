        ...
        <?php echo number_format($x['price'] * $value['soluong'], 0, '', '.'); ?> ₫
                        ...
                        <div class="col-md-2">
                            <div class="quantity-control">
                                ...
                                <input type="number" class="quantity-input" value="<?php echo $value['soluong'] ?>" min="1" readonly>
                                <button class="quantity-btn" onclick="increaseQuantity(this, <?php echo $x['id']; ?>)">+</button>
                            </div>
                        </div>
                        <div class="col-md-2 text-end">
                            <a href="./public/xulyCRUD/xulyXoaCart.php?idUser=<?php echo $_SESSION['user_id'] ?>&idProduct=<?php echo $x['id'] ?>">
            ...
            <div class="checkout-section">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <h4 class="mb-2">Tổng cộng: <span id="totalPrice"><?php echo number_format($Tongtien, 0, '', '.') ?> ₫</span></h4>
...
function updateCartQuantity(newQuantity, productId) {
    ...
    xhr.open('GET', './public/xulyCRUD/xulySuaCart.php?idUser=' + idUser + '&idProduct=' + productId + '&soluong=' + newQuantity, true);
    xhr.onload = function() {
        if (xhr.status === 200) {
